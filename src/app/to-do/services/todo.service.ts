...
export class TodoService {
  ...
  constructor(private storageSevices: LocalStorageService) { }

  fetchFromLocalStorage() {
    this.todos = this.storageSevices.getValue<Todo[]>(TodoService.TodoStorageKey) || [];
  ...
  updateToLocalStorage() {
    this.storageSevices.setObject(TodoService.TodoStorageKey, this.todos);
  ...
  editTodo(id: number, content: any) {
    const index = this.todos.findIndex(t => t.id === id);
    const todo = this.todos[index];
